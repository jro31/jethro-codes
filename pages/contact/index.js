...
const pageTitle = 'Contact | jethro.codes';
const appDescription = 'Want to hire me or just say hi, send me an email here.';
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='keywords'
          content='contact page, contact form, jethro.codes contact, Jethro Williams contact, Jethro Williams email'
        />
        ...
        <div className='relative max-w-xl mx-auto'>
          ...
          <div className='text-center'>
            ...
            <p className='mt-4 text-lg leading-6 text-gray-500'>
              Interested in working together, any comments or questions, or just want to say hi,
              ...
              <div>
                ...
                <div className='mt-1'>
                  <input
                    ...
                    onChange={event =>
                      handleFormFieldChange(setEnteredFirstName, event.target.value)
                    }
                  />
                </div>
              </div>
              <div>
                ...
                <div className='mt-1'>
                  <input
                    ...
                    onChange={event =>
                      handleFormFieldChange(setEnteredLastName, event.target.value)
                    }
                  />
                </div>
              </div>
